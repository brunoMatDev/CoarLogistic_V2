            ...
            return (
              ...
              >
                ...
                <div className="relative">
                  {/* Icon */}
                  <div className="mb-4">
                    <div className="w-12 h-12 rounded-lg flex items-center justify-center shadow-card group-hover:shadow-glow transition-all duration-300 bg-[hsl(var(--primary))]">
